...
<br />
<p>1. Pull the latest image from <a href="https://hub.docker.com/r/consumerdataright/mock-data-holder-energy" title="Download the from docker hub here" alt="Download the from docker hub here">Docker Hub</a></p>
...
<br />
<p>2. Run the Mock Data Holder Energy container</p>
...
<span style="display:inline-block;margin-left:1em;margin-top:10px;margin-bottom:10px;">
	...
	navigate to .\mock-data-holder-energy\Source<br \>
	open a command prompt and execute the following;<br \>
	docker build -f Dockerfile.container -t mock-data-holder-energy .<br \>
	docker run -d -h mdhe-host -p 8100:8100 -p 8101:8101 -p 8102:8102 -p 8105:8105 --add-host=host.docker.internal:host-gateway --name mock-data-holder-energy mock-data-holder-energy<br \><br \>
