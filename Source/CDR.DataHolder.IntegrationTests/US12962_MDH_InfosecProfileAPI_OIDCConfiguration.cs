...
#pragma warning restore IDE1006
        ...
        public async Task AC01_Get_ShouldRespondWith_200OK_OIDC()
        {
            ...
            using (new AssertionScope())
            {
                ...
                actual.scopes_supported.Should().BeEquivalentTo(new[] { "openid", "profile", "cdr:registration", "energy:accounts.basic:read", "common:customer.basic:read", "energy:accounts.concessions:read" });
                actual.claims_supported.Should().BeEquivalentTo(new[] { "name", "given_name", "family_name", "sharing_duration", "iss", "sub", "aud", "acr", "exp", "iat", "nonce", "auth_time", "updated_at" });
