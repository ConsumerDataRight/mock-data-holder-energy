...
namespace CDR.DataHolder.IdentityServer.Extensions
{
    public static class CollectionExtensions
    {
        ...
        {
            return scopes.ContainsScope(API.Infrastructure.Constants.StandardScopes.OpenId);
        }

        public static bool ContainsOfflineScopes(this IEnumerable<string> scopes)
        {
            return scopes.ContainsScope(API.Infrastructure.Constants.StandardScopes.OfflineAccess);
        }

        public static bool ContainsApiResourceScopes(this IEnumerable<string> scopes)
        {
            return scopes.ContainsScope(API.Infrastructure.Constants.ApiScopes.Energy.AccountsBasicRead) 
                || scopes.ContainsScope(API.Infrastructure.Constants.ApiScopes.Energy.ConcessionsRead)
                || scopes.ContainsScope(API.Infrastructure.Constants.ApiScopes.Common.CustomerBasicRead);
        }
