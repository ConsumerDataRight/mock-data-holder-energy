    ...
    public class Startup
    {
        ...
        private static void AddAuthenticationAuthorization(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddMvcCore().AddAuthorization(options =>
            {
                ...
                {
                    policy.Requirements.Add(new ScopeRequirement(CDR.DataHolder.API.Infrastructure.Constants.ApiScopes.Common.CustomerBasicRead, identityServerIssuer));
                ...
                {
                    policy.Requirements.Add(new ScopeRequirement(CDR.DataHolder.API.Infrastructure.Constants.ApiScopes.Energy.AccountsBasicRead, identityServerIssuer));
                    policy.Requirements.Add(new MtlsRequirement());
                    policy.Requirements.Add(new AccessTokenRequirement());
                });
                ...
                {
                    policy.Requirements.Add(new ScopeRequirement(CDR.DataHolder.API.Infrastructure.Constants.ApiScopes.Energy.ConcessionsRead, identityServerIssuer));
                    policy.Requirements.Add(new MtlsRequirement());
                    policy.Requirements.Add(new AccessTokenRequirement());
                });
            });
